...
class User
{
    ...
    public:
        ...
        friend long long int check_NIC(string);
};
        ...
        if (index != NOTEXISTS)
        {
            ...
            while (wrongPassCount >= 0)
            {
                ...
                else
                {
                    ...
                    if (wrongPassCount == 0)
                    {
                        cout << "\n\t\t\t\t\t\t\t\t\tThe password you entered is correct, no more tries left\n";
                        break;
                    }

                    else if (wrongPassCount > 1)
                    {
                        cout << "\n\t\t\t\t\t\t\t\t\tThe password you entered is correct, you have " << wrongPassCount-- << " tries left\n";
                    }

                    else
                    {
                        cout << "\n\t\t\t\t\t\t\t\t\tThe password you entered is correct, you have " << wrongPassCount-- << " try left\n";
                    }
...
string get_pass()
{
    ...
    while (true)
    {
        ...
        if (pass[i] == ENTER) // need to implement security (min characters, uppercase lowercase, numerics)
        {
            pass[i] = '\0';
            break;
        }
